        ...
        <div className={classes.container}>
            ...
            <div className={classes.bio}>
                ...
                <div className={classes.text}>
                    ...
                    <p>As a developer, I love being able to identify a problem and having the ability to directly plan and create a solution. My goal in designing software is to solve problems by creating intuitive software that is both adaptable and scalable.</p>
